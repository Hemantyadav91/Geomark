...
import { Home, History, Settings, LogOut, User as UserIcon } from 'lucide-react';
...
export default function StudentSettings() {
  ...
  const initials = currentUser?.name?.substring(0, 2).toUpperCase() || 'ST';

  return (
    <DashboardLayout navItems={navItems} user={{ name: currentUser?.name || 'Student', initials, role: 'Student' }}>
